...
ServerName = EncryptDecrypt.Decrypt(ConfigurationManager.ConnectionString("ServerName"))
Database = EncryptDecrypt.Decrypt(ConfigurationManager.ConnectionString("DatabaseName"))
